 ...
 */
@Slf4j
public class AlibabaVaultLocator extends AbstractVaultLocator {

    IAcsClient client;

    public AlibabaVaultLocator(IAcsClient client, Map<String, String> keys, boolean allowNotExists) {
